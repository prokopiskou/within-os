...
Κανόνες:
- "type": "code" αν περιγράφει ΟΠΟΙΑΔΗΠΟΤΕ αλλαγή/feature/fix/βελτίωση στο site/app/κώδικα — ακόμα κι αν είναι σε παρελθοντικό ή χαλαρό ύφος (π.χ. "πρόσθεσα κουμπί", "θέλω να μπει", "βάλε", "να αλλάξει", "φτιάξε", "διόρθωσε"). Σε αμφιβολία για το αν αφορά κώδικα, ΠΡΟΤΙΜΑ "code" (το PR το εγκρίνει ο χρήστης, οπότε δεν υπάρχει ρίσκο).
- "type": "task" ΜΟΝΟ όταν είναι ξεκάθαρα σημείωση/ιδέα/υπενθύμιση/στρατηγική ΧΩΡΙΣ αίτημα υλοποίησης (π.χ. "να θυμηθώ να γράψω newsletter", "ιδέα: campaign για Black Friday").
