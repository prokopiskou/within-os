...
- "clear": true ΜΟΝΟ αν ένας developer θα μπορούσε να ξεκινήσει χωρίς να ρωτήσει τίποτα. false αν λείπει κρίσιμη πληροφορία (π.χ. "άλλαξε το χρώμα" — ποιο στοιχείο; τι χρώμα;).
- "clarifyQuestion": αν clear=false, ΜΙΑ σύντομη, στοχευμένη ερώτηση στα ελληνικά για το πιο κρίσιμο που λείπει. Αλλιώς "".
- ΠΟΤΕ μην ρωτάς για το project ή για πράγματα που ήδη προσδιόρισε ο χρήστης. Αν ο χρήστης είπε ήδη το project, θεωρείται γνωστό — μην το ξαναρωτάς.
- Η ερώτηση πρέπει να αφορά ΜΟΝΟ την υλοποίηση που λείπει (π.χ. ποιο συγκεκριμένο στοιχείο, ποια τιμή/χρώμα/κείμενο). Όχι περισσότερα από ένα πράγμα.
- Μην ρωτάς για ασήμαντες λεπτομέρειες. Ρώτα μόνο όταν χωρίς την απάντηση δεν γίνεται σωστή δουλειά.

Απάντησε ΜΟΝΟ με JSON, χωρίς markdown:
{"projectId": "...", "type": "code|task", "title": "...", "body": "...", "confidence": 0.0, "clear": true, "clarifyQuestion": ""}`;
}
